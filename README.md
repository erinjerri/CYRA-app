...
| - 7 🔲 Instacart Integration | 🔲 Read ChatGPT4.1 (Operator documentation) with Instacart Playwright API  |  🔲  iterate genAI | 🔲 stuff | 🔲 stuff 
| - 8 🔲 Next iterations| 🔲 test in web, MacOS| 🔲 Submit request for ask Apple Dev during office hours for entitlements; handwriting recognizer with MNIST; passthrough camera frame | research papers one more time for other CUA benchmarks | 🔲 ask GSIs if there are other benchmarks I need to hit.
