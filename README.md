...
| - 4 🔲 Use Flask API. Check AVFoundation documentation to send to API | 🔲  | 🔲 Generate tasks with Llama | 🔲 test | 🔲 test
| - 5 ✅ Create initial GH Repo | - 🔲 Create shared JSON schema for cross-platform compatibility | - 🔲 Enable CloudKit container - CKRecord  | 🔲   | 🔲 Submit request for ask Apple Dev during office hours for entitlements; handwriting recognizer with MNIST; passthrough camera frame
